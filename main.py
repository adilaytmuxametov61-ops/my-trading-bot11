...
Original file is located at
    https://colab.research.google.com/drive/1YJ5ToZdeHch8zZYtzn5MRpsbqIWcn5FE
"""
...
def run_bot():
    ...
    send_telegram_message("✅ *Торговый бот для XAU/USD запущен.*\n\n"
                          f"**Стратегия:** EMA({EMA_SHORT_PERIOD}/{EMA_LONG_PERIOD}) + RSI({RSI_PERIOD})\n"
    ...
    while True:
        try:
            ...
            if data:
                ...
                if time.time() - last_signal_time > 3000: # не чаще чем раз в 50 минут
            ...
            # Для часового интервала достаточно проверять раз в 30-60 минут.
            # Бесплатный план Twelve Data имеет лимиты, не делайте запросы слишком часто.
            print("Пауза на 30 минут...")
            time.sleep(1800)
